...
# 표정변화율과 눈 깜박임을 분석하는 face 엔진 입니다.
class Eye_check:
    # 초기값
    def __init__(self):
    ...
    # 영상에서 눈 이미지의 영역의 좌표값과 눈 이미지를 반환하는 함수 입니다. 
    ...
    # 오른쪽 눈 이미지를 눈 깜박임 감지 모델에 적용하는 함수입니다. 
    ...
    # Mediapipe 를 사용해 얼굴 랜드마크 dict 타입으로 저장하는 함수입니다.
